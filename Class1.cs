...
namespace RaceAnalyzer
{
    public class RaceAnalyzer : IPlugin
    {
        ...
        {
            if (dyn.data.race_scenario == null || dyn.data.random_seed == null || dyn.data.race_horse_data_array == null || dyn.data.trained_chara_array == null || dyn.data.season == null || dyn.data.weather == null || dyn.data.ground_condition == null)
                return;
        ...
        {
            if (dyn.data.trained_chara_array == null || dyn.data.race_result_info == null || dyn.data.entry_info_array == null || dyn.data.practice_race_id == null || dyn.data.state == null || dyn.data.practice_partner_owner_info_array == null)
                return;
        ...
        {
            if (dyn.data.room_info == null || dyn.data.room_user_array == null || dyn.data.race_horse_data_array == null || dyn.data.trained_chara_array == null)
            {
                return;
            }
